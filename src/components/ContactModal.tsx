  ...
  const contactOptions = [
    {
      ...
      action: () => {
        window.open('tel:+79165788898', '_self');
        handleClose();
      },
    ...
    },
    {
      ...
      action: () => {
        window.open('https://wa.me/79165788898', '_blank');
        handleClose();
      },
    ...
    },
    {
      ...
      action: () => {
        window.open('https://t.me/AUTOVED_manager', '_blank');
        handleClose();
      },
    ...
    },
    {
      ...
      action: () => {
        window.open('https://www.instagram.com/auto_ved', '_blank');
        handleClose();
      },
